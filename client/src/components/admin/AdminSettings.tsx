    ...
    <div className="mx-auto max-w-2xl space-y-6">
      <div className="glass p-6">
        ...
        <div className="flex items-center justify-between rounded-xl bg-primary-soft/40 p-4">
          <div><p className="font-medium">Theme</p><p className="text-sm text-ink-2">{isDark ? 'Dark mode active' : 'Light mode active'}</p></div>
      ...
      <div className="glass p-6">
        ...
        <p className="text-sm text-ink-2">Signed in as <b>{user?.email}</b> · Full administrative access</p>
      </div>
    </div>
  );
}
